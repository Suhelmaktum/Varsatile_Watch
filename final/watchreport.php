...
<body>
	<form action="watchreport.php " method="post">
...
$prop=array(
			'padding'=>3);
$pdf->Table('select user_name,order_master.orders_id,watch_name,price,quantity,total from customer,order_detail,order_master where user_id=customer_id and order_detail.orders_id=order_master.orders_id',$prop);
