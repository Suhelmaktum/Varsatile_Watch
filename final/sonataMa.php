...
$query="select * from watch where category = 'Men'";
$result=mysqli_query($con,$query);
...
<li class="products">
	<form method="post" action="sonataMa.php?id=<?php echo $row['watch_id'];?>">
		<ul>
		<center><div class="product-content"><h3><?php echo $row['watch_name'];?></h3></div>
			<a href="sonataMa.php?watch_id=<?php echo $row['watch_id'];?>"><?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row[2]).'" height="30%",align="center">';?></div></a>
			<br><br>
